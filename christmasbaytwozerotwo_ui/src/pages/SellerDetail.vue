						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="ShopName" type="text" placeholder="Enter ShopName" v-model="sellerToAdd.shopName"></base-input>
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Seller Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Shop Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ShopName" type="text" placeholder="Enter ShopName" v-model="sellerDetails.shopName"></input>
																		</div>
						</td>
														</tr>
															<tr> 
