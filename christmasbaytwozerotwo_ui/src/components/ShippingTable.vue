...
<template>
  ...
  <base-input label="EstimatedDeliveryDate" type="text" placeholder="Enter EstimatedDeliveryDate" v-model="shippingToAdd.estimatedDeliveryDate"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'estimatedDeliveryDate',
          visible: true,
          scopedSlots: { customRender: 'estimatedDeliveryDate' },
          sorter: true
          //sorter: (a, b) => a.estimatedDeliveryDate - b.estimatedDeliveryDate,
          //sorter: (a, b) => a.estimatedDeliveryDate.localeCompare(b.estimatedDeliveryDate),
        },
      ],
      pagination: {
        current: 1,
